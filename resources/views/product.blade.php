...
<!-- Mirrored from htmlstream.com/preview/unify-v1.9.1/E-Commerce/shop-ui-inner.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Mar 2016 18:12:32 GMT -->
<head>
			...
			<div class="tab-v6">
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade" id="reviews">
						...
						<form action="http://htmlstream.com/preview/unify-v1.9.1/E-Commerce/assets/php/demo-contacts-process.php" method="post" id="sky-form3" class="sky-form sky-changes-4">
							<fieldset>
	...
	<div class="style-switcher animated fadeInRight">
		...
		<div class="style-swticher-body">
			...
			<ul class="list-unstyled">
				...
				<li class="theme-teal theme-active last" data-style="teal" data-header="light"></li>
			</ul>
			...
			<div class="row no-col-space">
				...
				<div class="col-xs-6">
					<a href="RTL/shop-ui-inner.html" class="btn-u btn-u-xs btn-u-dark btn-block">LTR <small class="dp-block">Version</small></a>
				</div>
			</div>
		</div>
	</div><!--/style-switcher-->
...
<!-- Mirrored from htmlstream.com/preview/unify-v1.9.1/E-Commerce/shop-ui-inner.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Mar 2016 18:12:51 GMT -->
</html>
